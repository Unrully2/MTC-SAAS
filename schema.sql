...
-- Public / Anon access policies (allows application frontend to read and write records)
CREATE POLICY "Allow public read and write on profiles" ON public.profiles FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Allow public read and write on students" ON public.students FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Allow public read and write on fee_invoices" ON public.fee_invoices FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Allow public read and write on fee_payments" ON public.fee_payments FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Allow public read and write on exam_results" ON public.exam_results FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Allow public read and write on courses" ON public.courses FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Allow public read and write on announcements" ON public.announcements FOR ALL USING (true) WITH CHECK (true);

-- Explicit Role Grants for Supabase Anonymous & Authenticated Users
